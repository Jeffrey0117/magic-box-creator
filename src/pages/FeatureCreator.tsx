...
const FeatureCreator = () => {
  ...
  return (
    <div className="min-h-screen dark:from-slate-900 dark:to-slate-800" style={{ backgroundColor: '#F8F7F5' }}>
      {/* Top Banner */}
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ backgroundColor: '#F8F7F5' }}>
